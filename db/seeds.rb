...
novak = User.create!(first_name: "Novak", last_name: "Djokovic", address: "Serbie", gender: "Man", email: "novak@atp.com", password: "secret", level: classement.shuffle.first, description: novak_desc, photo: "https://res.cloudinary.com/dhtapshlv/image/upload/v1592421797/Novak_Djokovic_64_srhdni.jpg")
nadal = User.create!(first_name: "Rafael", last_name: "Nadal", address: "Espagne", gender: "Man", email: "rafael@atp.com", password: "secret", level: classement.shuffle.first, description: nadal_desc,  photo: "https://res.cloudinary.com/dhtapshlv/image/upload/v1592421832/Rafael_Nadal_100_rauek2.jpg")
dominic = User.create!(first_name: "Dominic", last_name: "Thiem", address: "Autriche", gender: "Man", email: "dominic@atp.com", password: "secret", level: classement.shuffle.first, description: dominic_desc, photo: "https://res.cloudinary.com/dhtapshlv/image/upload/v1592421861/Dominic_Thiem_85_w3icfr.jpg")
federer = User.create!(first_name: "Roger", last_name: "Federer", address: "Suisse", gender: "Man", email: "roger@atp.com", password: "secret", level: classement.shuffle.first, description: roger_desc, photo: "https://res.cloudinary.com/dhtapshlv/image/upload/v1592421896/Roger_Federer_73_uqnvux.jpg")
stan = User.create!(first_name: "Stan", last_name: "Wawrinka", address: "Suisse", gender: "Man", email: "stan@atp.com", password: "secret", level: classement.shuffle.first, description: stan_desc, photo: "https://res.cloudinary.com/dlwpvvdub/image/upload/c_fill,g_auto:face,h_250,w_250/v1592474095/Stanislas-Wawrinka_mg9jna.jpg")
stefanos = User.create!(first_name: "Stefanos", last_name: "Tsitsipas", address: "Grece", gender: "Man", email: "stefanos@atp.com", password: "secret", level: classement.shuffle.first, description: stefanos_desc, photo: "https://res.cloudinary.com/dlwpvvdub/image/upload/c_fill,g_face,h_200,q_auto:best,w_200/v1592486076/file73qv0qddg1ubuwk1ayv_pcswf4.jpg")
